          ...
          <Route path="/" element={
            <div className="p-5 mb-4 bg-light rounded-3 shadow-sm">
              <div className="container-fluid py-5">
                ...
                <p className="lead">Track your fitness, join teams, and compete on the leaderboard. Use the navigation menu to explore activities, teams, users, workouts, and more.</p>
